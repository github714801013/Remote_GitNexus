...
export PATH="/app/gitnexus/dist/cli:$PATH"
...
export GITNEXUS_EMBEDDING_BATCH_SIZE="${GITNEXUS_EMBEDDING_BATCH_SIZE:-32}"
...
node /app/gitnexus/dist/cli/index.js serve --port 1347 --host 0.0.0.0 &
serve_pid=$!
